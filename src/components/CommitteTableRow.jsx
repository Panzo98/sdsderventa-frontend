...
export default function CommitteTableRow({ data, newId }) {
  ...
  const handleDelete = async () => {
    try {
      ...
      //   );
      //   dispatch({ type: "DELETE_COMMITTE", payload: data.id });
      //   alert(`Odbor ${data.name} uspjesno izbrisan!`);
    } catch (error) {
      //   alert("Desila se greska prilikom brisanja odbora!!");
    }
  };
  return (
